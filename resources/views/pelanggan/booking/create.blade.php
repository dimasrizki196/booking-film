            ...
            <form action="{{ route('booking.store') }}" method="POST" class="space-y-8">
                ...
                <div>
                    ...
                    <div x-data="{
                        ...
                        init() {
                            // Set nilai awal jika ada old() dari validasi yang gagal
                            this.$nextTick(() => {
                                if (this.selectedId) {
                ...
                <div class="border-t border-zinc-100 pt-6">
                    <label class="block text-lg font-extrabold text-zinc-900 mb-4 tracking-tight">2. Tentukan Waktu
                        Pelaksanaan</label>
                ...
                <div class="flex flex-col sm:flex-row items-center gap-4 pt-4 mt-6 border-t border-zinc-100">
                    <button type="submit"
