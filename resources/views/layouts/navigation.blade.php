...
<div x-data="{ open: false }">
    ...
    <!-- 1. HEADER MOBILE (Fixed Mengunci di Atas, Efek Kaca Bening) -->
    <div
    ...
    <nav :class="{ 'translate-x-0': open, '-translate-x-full': !open }"
        ...
        <div class="p-4 border-t border-zinc-800/60 bg-zinc-950/40">
            <div class="px-4 mb-4">
                ...
                <div class="font-medium text-sm text-zinc-400 truncate mt-0.5">{{ Auth::user()->email }}</div>
            </div>
