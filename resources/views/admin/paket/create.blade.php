<x-app-layout>
                ...
                <form action="{{ route('admin.paket.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" rows="3"
                            ...
                            placeholder="Jelaskan gambaran umum tentang paket layanan ini..." required>{{ old('deskripsi') }}</textarea>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Inisialisasi: Jika ada old input (misal gagal validasi), munculkan poin sebelumnya
            if (hiddenDetail) {
                ...
                // Jika baru pertama kali buka form (kosong), munculkan 1 baris input sebagai pancingan
                if (addedCount === 0) {
                    createDetailRow('');
                }
            }
